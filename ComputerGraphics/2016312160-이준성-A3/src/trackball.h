...
inline std::vector<sphere_t> create_spheres()
{
	...
	sphere_t s;
	s = { vec3(0,0,0),10.0f,0.0f,1.0f};
	spheres.emplace_back(s);
	s = { vec3(0,0,0),1.0f,0.0f,6.0f, 15.0f };
	spheres.emplace_back(s);
	s = { vec3(0,0,0),2.0f,0.0f,3.7f, 10.0f };
	spheres.emplace_back(s);
	s = { vec3(0,0,0),5.0f,0.0f,5.2f, 6.0f };
	spheres.emplace_back(s);
	s = { vec3(0,0,0),3.0f,0.0f,2.3f, 14.0f };
	spheres.emplace_back(s);
	s = { vec3(0,0,0),7.0f,0.0f,1.3f, 8.0f };
	spheres.emplace_back(s);
	s = { vec3(0,0,0),3.0f,0.0f,3.7f, 23.0f };
	spheres.emplace_back(s);
	s = { vec3(0,0,0),2.0f,0.0f,0.3f, 38.0f };
	spheres.emplace_back(s);
	s = { vec3(0,0,0),3.0f,0.0f,1.2f, 28.0f };
	spheres.emplace_back(s);
	return spheres;
}
